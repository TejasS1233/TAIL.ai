    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          title={nodes.length === 0 ? "Add nodes first" : "Save workflow"}
        >
        ...
        <Button
          ...
          size="sm"
          disabled={nodes.length === 0}
          title={nodes.length === 0 ? "Add nodes first" : "Share workflow"}
        >
        ...
        <Button
          ...
          size="sm"
          disabled={nodes.length === 0}
          title={nodes.length === 0 ? "Add nodes first" : "Export JSON"}
        >
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                <div className={`w-6 h-6 ${node.color} rounded flex items-center justify-center`}>
